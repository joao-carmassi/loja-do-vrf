...
function Footer(): React.ReactNode {
  return (
    <footer className='mx-auto max-w-[95rem] p-6 md:p-12 md:pt-0 space-y-6'>
      <div className='flex flex-col md:flex-row items-center justify-center gap-6'>
        ...
        <div className='space-y-3'>
          ...
          <p className='text-sm lg:text-base text-center md:text-start'>
            Nosso diferencial está em oferecer preços competitivos e o prazo de
            entrega mais curto do mercado, garantindo que nossos clientes tenham
            acesso rápido às soluções que precisam, com qualidade e economia.
          </p>
        </div>
      </div>
      ...
      <div className='w-full flex flex-col lg:flex-row items-center md:items-start justify-between'>
        <div>
          <h3 className='font-bold text-primary md:text-lg'>Meios de envio:</h3>
